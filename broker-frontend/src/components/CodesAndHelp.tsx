...
const CodesAndHelp: React.FC = () => {
    ...
    const getTransactionCodes = () => [
        {code: 'A', description: t('help.transactionCodes.assignment'), category: t('help.categories.trading')},
        {code: 'O', description: t('help.transactionCodes.opening'), category: t('help.categories.trading')},
        {code: 'C', description: t('help.transactionCodes.closing'), category: t('help.categories.trading')},
        {code: 'L', description: t('help.transactionCodes.liquidation'), category: t('help.categories.trading')},
        {code: 'T', description: t('help.transactionCodes.transfer'), category: t('help.categories.trading')},
        {code: 'D', description: t('help.transactionCodes.dividend'), category: t('help.categories.income')},
        {code: 'DIV', description: t('help.transactionCodes.dividend'), category: t('help.categories.income')},
        {code: 'INT', description: t('help.transactionCodes.interest'), category: t('help.categories.income')},
        {code: 'F', description: t('help.transactionCodes.fee'), category: t('help.categories.costs')},
        {code: 'FEE', description: t('help.transactionCodes.fee'), category: t('help.categories.costs')},
        {code: 'TAX', description: t('help.transactionCodes.tax'), category: t('help.categories.costs')},
        {code: 'ADJ', description: t('help.transactionCodes.adjustment'), category: t('help.categories.other')},
        {code: 'CORP', description: t('help.transactionCodes.corporateAction'), category: t('help.categories.other')}
    ];
